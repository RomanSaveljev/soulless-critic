...
exports.prepare = function(parameters, complete) {
  ...
  assert(parameters.git !== undefined);
  assert(parameters.git.baseUrl !== undefined);
  assert(parameters.eventData !== undefined);
  assert(parameters.eventData.change !== undefined);
  assert(parameters.eventData.change.project !== undefined);
  assert(parameters.eventData.change.number !== undefined);
  assert(parameters.eventData.patchSet !== undefined);
  assert(parameters.eventData.patchSet.number !== undefined);
  assert(parameters.eventData.patchSet.ref !== undefined);
